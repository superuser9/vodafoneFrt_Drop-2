...
public class AcceptLeaveStatusFragment extends DialogFragment  implements  FRTAsyncCommon.FetchDataCallBack {

    private FRTUtility frtUtility;

    private ProgressDialog progressDialog;
    private AcceptLeaveStatusFragment rejectedTaskIssueFragment = this;
    ...
    private ArrayList<Integer> leaveIdList;
    private String issueIdText;

    public static AcceptLeaveStatusFragment newInstance(){
        return new AcceptLeaveStatusFragment();
    }
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        if (bundle != null){
           // leaveIdValue = bundle.getInt("LEAVE_ID");
            leaveIdList = bundle.getIntegerArrayList("LEAVE_ID");

            issueIdText = leaveIdList.toString().replace("[", "").replace("]", "");
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, Bundle savedInstanceState) {
        ...
        View dialogView = inflater.inflate(R.layout.leave_accepte_dialog_fragment,container,false);
        setCancelable(false);
       // dialogView.getWindow().requestFeature(Window.FEATURE_NO_TITLE);
    ...
    private void toAcceptLeaveStatus() {
    ...
    private MGRRequestUpdateLeaveStatus setAssignRejectDetailModel() {
        ...
        try {
           ...
           // mgrRequestUpdateLeaveStatus.setLeaveId(Integer.parseInt(issueIdText));
            mgrRequestUpdateLeaveStatus.setLeaveIds(issueIdText);
            mgrRequestUpdateLeaveStatus.setStatus("Approved");
            mgrRequestUpdateLeaveStatus.setRemark("");
        ...
        if (response != null){
                ...
                try {
                    ...
                    if (jsonObject.optString("status").equals("OK")) {
                        Toast.makeText(getActivity(), getString(R.string.leaveApprovedSuccessfully), Toast.LENGTH_SHORT).show();

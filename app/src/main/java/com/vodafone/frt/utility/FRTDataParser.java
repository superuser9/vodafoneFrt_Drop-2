...
class FRTDataParser {
    ...
    public List<List<HashMap<String, String>>> parse(JSONObject jObject) {
        ...
        JSONArray jLegs;
        JSONArray jSteps;
        JSONObject distanceObject, timeObject;
        ...
        try {
            ...
            for (int i = 0; i < jRoutes.length(); i++) {
                ...
                for (int j = 0; j < jLegs.length(); j++) {
                    distanceObject = ((JSONObject) jLegs.get(j)).getJSONObject("distance");
                    distance = distanceObject.getString("text");
                    timeObject = ((JSONObject) jLegs.get(j)).getJSONObject("duration");

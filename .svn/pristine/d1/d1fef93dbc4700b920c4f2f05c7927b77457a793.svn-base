...
public class PTRResponseScheduleRouteModel implements Comparable<PTRResponseScheduleRouteModel> {
    ...
    @Override
    public int compareTo(@NonNull PTRResponseScheduleRouteModel o) {
        return getStart_date().compareTo(o.getStart_date());
    }

...
public class PTRScheduledRouteAdapter extends BaseAdapter {
    private final Context context;
    private SelectionViewAttendanceListener listener;
    private List<PTRResponseScheduleRouteModel> dataSet;

    public PTRScheduledRouteAdapter(Context context) {
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            ...
            convertView = inflater.inflate(R.layout.item_scheduled_route_list, parent, false);
        ...
        holder.assignment_type.setText(scheduledroute.getAssignment_type());

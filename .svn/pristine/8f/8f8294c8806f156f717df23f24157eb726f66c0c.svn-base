...
public class FRTLocationUploaderService /*extends Service implements LocationListener,
    ...
    List<PTRResponsePlannedRouteModel> frtResponsePlannedRouteModelList;
    MyThread t;
...
//                    prevTime = t;
    ...
    private void getPlannedRouteData(Context context) {
        if (frtCnnectivityReceiver.isConnected(context)) {
            ...
            final FRTAsyncCommon<PTRRequestPlannedRouteModel> frtAsyncCommon = FRTAsyncCommon.getAsyncInstance();
    ...
    private void getRouteTrackData(final Context context, final long t, long prevTime) {
        ...
        if (frtCnnectivityReceiver.isConnected(context)) {
            FRTAsyncCommon<PTRRequestSaveRouteLocationmodel> frtAsyncCommon = FRTAsyncCommon.getAsyncInstance();
            frtAsyncCommon.setContext(context);
...
//            }
    ...
    private PTRRequestSaveRouteLocationmodel setUpSaveRouteModel(Context context) {
